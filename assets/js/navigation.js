...
function toggleSkinCare() {
  var menu  = document.getElementById('skincare-menu');
  var arrow = document.getElementById('skincare-arrow');
  if (!menu) return;
  var isOpen = menu.classList.contains('nav-menu-open');
  menu.classList.toggle('nav-menu-open', !isOpen);
  menu.classList.toggle('nav-menu-hidden', isOpen);
...
function toggleLibrary() {
  var menu  = document.getElementById('library-menu');
  var arrow = document.getElementById('library-arrow');
  if (!menu) return;
  var isOpen = menu.classList.contains('nav-menu-open');
  menu.classList.toggle('nav-menu-open', !isOpen);
  menu.classList.toggle('nav-menu-hidden', isOpen);
